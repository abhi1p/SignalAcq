    ...
    QStandardItemModel(parent)
{
    ...
    connect(this,&PortList::rowsInserted,this,&PortList::onRowsInserted,Qt::QueuedConnection);
}
...
void PortList::loadPortList()
{
    ...
    disconnect(this, &PortList::rowsInserted,0,0);
    // disconnect(this,&PortList::onRowsInserted,this,&PortList::onRowsInserted);
