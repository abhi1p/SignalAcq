...
const char SG_MainWindow_SelectedDevice[] = "SelectedDevice";
...
const char SG_Commands_CommandSerial[] = "commandSerial";
const char SG_Commands_CommandBLE[] = "commandBLE";
const char SG_Commands_Name[] = "name";
const char SG_Commands_Type[] = "type";
const char SG_Commands_Data[] = "data";
const char SG_Commands_ServcUuid[] = "ServcUuid";
const char SG_Commands_CharUuid[] = "CharUuid";
const char SG_Commands_CharFlags[] = "CharFlags";
